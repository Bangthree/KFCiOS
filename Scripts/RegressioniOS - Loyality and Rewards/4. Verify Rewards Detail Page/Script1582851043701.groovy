...
WebUI.comment('Voucher Detail Page Check')
...
Mobile.tap(findTestObject('iOS/Voucher List Page/vouchlist_header_btnBack'), 1)

Mobile.tap(findTestObject('iOS/Profile Page/profilepage_header_btnBack'), 1)
